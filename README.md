...
-   Random-number generators for parallel computing are available via the [rlecuyer](https://cran.r-project.org/package=rlecuyer/index.html) package, the [rstream](../packages/rstream/index.html) package, the [sitmo](../packages/sitmo/index.html) package as well as the [dqrng](../packages/dqrng) package.
