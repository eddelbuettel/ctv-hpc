...
-   Random-number generators for parallel computing are available via the [rlecuyer](https://cran.r-project.org/package=rlecuyer/index.html) package, as well as the [sitmo](../packages/sitmo) package.
