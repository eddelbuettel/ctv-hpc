...
-   The [<span
    class="BioC">maanova</span>](https://www.Bioconductor.ohttps://cran.r-project.org/package=release/bioc/html/maanova.html)
...
-   The [bcp](https://cran.r-project.org/package=bcp) package by Erdman and Emerson
    ...
    operations.
-   The [<span
    class="BioC">multtest</span>](https://www.Bioconductor.ohttps://cran.r-project.org/package=release/bioc/html/multtest.html)
...
-   The [Matching](https://cran.r-project.org/package=Matching) package by Sekhon
    ...
    class="BioC">affyPara</span>](https://www.Bioconductor.ohttps://cran.r-project.org/package=release/bioc/html/affyPara.html)
